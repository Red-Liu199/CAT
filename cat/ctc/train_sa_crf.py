...
from .train import AMTrainer, main_worker
...
def build_model(cfg: dict, args: argparse.Namespace) -> Union[AbsEncoder, SACRFTrainer]:
    ...
    # this is a hack avoid passing 'trainer' arguents into ctc builder
    cfg['trainer'] = {}
...
def main(args: argparse.Namespace = None):
    ...
    coreutils.main_spawner(args, main_worker, [build_model])
