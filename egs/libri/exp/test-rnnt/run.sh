...
if [ $stage -le 2 ] && [ $stop_stage -ge 2 ]; then
    # Convert to pickle
    python3 ctc-crf/convert_to.py -f=pickle --filer 250 \
        data/all_ark/cv.scp $spmdata/dev/text_number $data_dev/weight $dir/cv.pickle || exit 1

    python3 ctc-crf/convert_to.py -f=pickle --filer 250 \
        data/all_ark/tr.scp $spmdata/train/text_number $data_train/weight $dir/tr.pickle || exit 1
